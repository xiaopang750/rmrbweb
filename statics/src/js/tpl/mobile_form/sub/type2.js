/*TMODJS:{"version":77,"md5":"cc7f1dda60e7fa3b0fd276975b25a329"}*/
define(function(require) {
    return require("../../mobile_temp_list/module_list2"), require("../../templates")("mobile_form/sub/type2", function($data, $filename) {
        "use strict";
        ...
        $out += $escape(content.bgImg.modelData.bgImgUrl), $out += '" sub-name="bgImgUrl" r-upload-url> </span> <span class="r-btn mobile-upload fl" r-upload-btn></span> <span class="fl red mt-5 ml-5 font-14">*</span> </div> </div> </div>  <div class="edit-card mobile-edit-section" sub-type data-name="', 
        $out += $escape(content.modelars.modelName), $out += '"> <div class="mobile-edit-title font_13 bold"> <span class="r-icon mobile-pic ml-8 mr-5"></span> <span class="blue">列表编辑：</span> </div> <div class="mobile-edit-content"> <div class="inner clearfix" sub-wrap ctype="multi" data-ele="sort-wrap" now="', 
        $out += $escape(content.modelars.modelData.length), $out += '" min="8" max="10"> ', 
        include("../../mobile_temp_list/module_list2"), $out += ' </div> <div class="tc pb-10"> <span class="r-btn mobile-list-add mt-10" mobile-list-add add-name="oTplList2"></span> </div> </div> </div>', 
        new String($out);
    });
});