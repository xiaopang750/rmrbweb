/*TMODJS:{"version":1,"md5":"1e799609b4bf658596bfcf95a7e03af6"}*/
define(function(require) {
    return require("./option"), require("../../../templates")("spread/question/form/list1", function($data, $filename) {
        "use strict";
        ...
        return $out += " ", $each(question, function($value, $index) {
            ...
            $out += '"> <div class="q-list-l"> <div class="q-func-wrap ml-5"> <div class="q-list-num font-16 mb-10 clearfix"> <span class="fl">Q</span> <span q-list-num class="fl"> ', 
