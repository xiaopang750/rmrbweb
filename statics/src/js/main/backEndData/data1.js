...
define(function(require, exports, module){
	...
	var oTpl = require('../../tpl/backEndData/temp1');
	var oTip = require('../../widget/dom/tip');
	var tab = require('../../widget/dom/tab');
	require('../../widget/highcharts/highcharts');

	var BackEndData1 = R.Class.create(R.until, {
		...
		showPage: function() {
			...
			this.reqUrl = R.interfaces.data1;
	...
	var oBackEndData1 = new BackEndData1();
