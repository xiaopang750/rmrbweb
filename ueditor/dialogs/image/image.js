...
(function () {
    ...
    function _bodyParse() {
        ...
        if(window.parent.location.search) {
            ...
            str = decodeURIComponent(window.parent.location.search.split('?')[1]);
    ...
    var _info = _bodyParse();

    var  _pageid = _info.id;
    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            uploader.on('all', function (type, files) {
                //need-modify
                /*var onlineManage = window.parent.location.search.split("?")[1];
                var nowId;
                if(onlineManage.indexOf("sin")!= - 1 || onlineManage.indexOf("sin")!= - 1) {
                ...
                switch (type) {
                    ...
                    case 'startUpload':
                        ...
                        var params = utils.serializeParam(editor.queryCommandValue('serverparam')) || '',
                            url = utils.formatUrl(actionUrl + (actionUrl.indexOf('?') == -1 ? '?':'&') + 'encode=utf-8&way=editor&fileBelong='+ _pageid + params);
            ...
            if(!_this.listEnd && !this.isLoadingData) {
                ...
                ajax.request(url, {
                    ...
                    'data': utils.extend({
                            ...
                            size: this.listSize,
                            "pic.standy1": _pageid  //need-modify
